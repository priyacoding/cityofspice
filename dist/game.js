...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  __name(setupPlayer, "setupPlayer");
  var levels = [
    [
      "                           ",
      "                           ",
  ...
  function setupMap() {
    ...
    bg1a = add([pos(0, 0), sprite("bg1"), scale(4), z(-2), "bg1"]), bg1b = add([pos(-1088, 0), sprite("bg1"), scale(4), z(-2), "bg1"]), bg2a = add([pos(0, 0), sprite("bg2"), scale(4), z(-2), "bg2"]), bg2b = add([pos(-1088, 0), sprite("bg2"), scale(4), z(-2), "bg2"]), bg3a = add([pos(0, 0), sprite("bg3"), scale(4), z(-2), "bg3"]), bg3b = add([pos(-2176, 0), sprite("bg3"), scale(4), z(-2), "bg3"]), onKeyPress(() => {
      if (!gameOn) {
        setupSpawner(20, 0.5);
      }
    });
  ...
  __name(setupSpawner, "setupSpawner");
  ...
  __name(setupScoretracker, "setupScoretracker");
  function setupCollisions() {
    onUpdate("pepper", (p) => {
      p.pos.y += 5;
    });
    onCollide("player", "spike", (p, f2, collision) => {
      shake(10), go("leveldone");
    });
    onCollide("pepper", "solidBlock", (p, f2, collision) => {
      destroy(f2), destroy(p);
      shake(10), add([
  ...
  __name(setupCollisions, "setupCollisions");
  scene("game", () => {
    totsc += score;
    score = 0;
    add([
